...
import com.thunder.thundertweaks.utils.kernel.misc.PowerSuspend;
import com.thunder.thundertweaks.utils.kernel.misc.Pwm;
import com.thunder.thundertweaks.utils.kernel.misc.Selinux;
import com.thunder.thundertweaks.utils.kernel.misc.Vibration;
import com.thunder.thundertweaks.utils.kernel.misc.Wakelocks;
...
public class MiscFragment extends RecyclerViewFragment {
    ...
    private void powersuspendInit(List<RecyclerViewItem> items) {
        ...
        if (PowerSuspend.hasMode()) {
            ...
            if (v.contains("1.5") || v.contains("1.8") || v.contains("1.9") || v.contains("2.0")) {
